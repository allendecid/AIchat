...
(function($) {
    $.widget("ui.chatbox", {
        ...
        _create: function() {
            ...
            uiChatboxRest = (self.uiChatboxRest = $('<div><ul>	<li>		<a href="#"><i></i>Related Questions</a>	<ul id="respuestarel">		</ul>		</li>	<li>		<a href="#"><i></i>Contact</a>		<ul class="closedt">			<li>Phone: Name 888-888888</li>			<li>Email: email@email.com</li></ul></li>	</ul></div>'))
                .addClass('ui-widget-content ' +
                          'ui-chatbox-rest ' 
                         )
                .appendTo(uiChatboxContent),
